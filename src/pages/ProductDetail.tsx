                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <h1 className="catalog-heading text-4xl md:text-5xl font-extrabold mt-4 leading-tight">
                                {product.name}
                            </h1>
                            ...
                            <div className="mt-4 flex items-center">
                                {product.stock > 0 ? (
                                    <div className="catalog-muted flex items-center font-semibold">
                                    ...
                                    <div className="catalog-muted flex items-center font-semibold opacity-80">
                                        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        {/* Description */}
                        <div className="catalog-detail-panel rounded-2xl p-6">
                            ...
                            <p className="catalog-muted whitespace-pre-line leading-relaxed">
                                {product.description}
                            </p>
                        </div>
                            ...
                            <div className="catalog-detail-panel rounded-2xl p-6">
                                ...
                                <dl className="space-y-3">
                                    {Object.entries(product.specifications).map(([key, value]) => (
                                        <div key={key} className="catalog-spec-row flex justify-between items-center py-3 border-b last:border-0">
                        ...
                        {/* WhatsApp Button */}
                        <div className="catalog-whatsapp-panel rounded-2xl p-6">
                            ...
                            <p className="catalog-muted mb-4">
