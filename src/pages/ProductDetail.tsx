        ...
        <main className="catalog-detail-shell min-h-screen">
            ...
            <div className="catalog-detail-breadcrumb">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <nav className="flex min-w-0 items-center space-x-2 overflow-hidden text-[13px] sm:text-sm">
                        ...
                        <span className="catalog-muted truncate font-medium">{product.name}</span>
                    </nav>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
                    ...
                    <section aria-labelledby="servico-titulo" className="space-y-6">
                        <div className="catalog-detail-hero-panel rounded-[1.75rem] p-5 sm:p-6 md:p-8">
                            ...
                            {showsStartingPrice && (
                                <div className="catalog-detail-price-row mt-6 sm:mt-8 py-5 sm:py-6">
                                    <div>
                                        <p className="mb-2 text-xs uppercase tracking-[0.28em] text-[#404040]">
                                            Valor inicial
                                        </p>
                                        <p className="catalog-price text-3xl font-extrabold leading-tight sm:text-4xl">
