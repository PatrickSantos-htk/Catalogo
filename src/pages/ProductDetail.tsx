...
export default function ProductDetail() {
    ...
    return (
        <div className="catalog-detail-shell min-h-screen">
            {/* Breadcrumb */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="catalog-detail-panel rounded-2xl p-6 md:p-7">
                            <h2 className="catalog-heading text-2xl font-bold mb-4 flex items-center">
                                <svg className="w-6 h-6 mr-2 text-[#404040]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                Descricao
                            </h2>
                            <p className="catalog-detail-description catalog-muted whitespace-pre-line text-[1.02rem]">
                                {product.description}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="catalog-detail-hero-panel rounded-[1.75rem] p-6 md:p-8">
                            <span className="catalog-pill inline-block px-4 py-1.5 text-sm font-bold rounded-full uppercase tracking-wide">
                                {product.category}
                            </span>

                            <h1 className="catalog-heading text-4xl md:text-5xl font-extrabold mt-5 leading-tight">
                                {product.name}
                            </h1>

                            <div className="catalog-detail-price-row mt-8 py-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                                <div>
                                    <p className="text-xs uppercase tracking-[0.28em] text-[#404040] mb-2">
                                        investimento inicial
                                    </p>
                                    <p className="catalog-price text-5xl font-extrabold">
                                        {formatCurrency(product.price)}
                                    </p>
                                </div>
                                <div className="catalog-pill inline-flex items-center self-start px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] rounded-full sm:self-auto">
                            ...
                            <div className="mt-6 grid gap-3 sm:grid-cols-2">
                                <div className="catalog-detail-panel rounded-2xl p-4">
                                    ...
                                    <p className="catalog-heading font-semibold">Resposta rapida no WhatsApp</p>
                                </div>
                                <div className="catalog-detail-panel rounded-2xl p-4">
                                    <p className="text-xs uppercase tracking-[0.26em] text-[#404040] mb-2">categoria</p>
                                    <p className="catalog-heading font-semibold">{product.category}</p>
                                </div>
                            </div>

                            <div className="catalog-detail-inline-cta mt-6 rounded-2xl p-5 md:p-6">
                                <h3 className="catalog-heading text-xl font-bold mb-2 flex items-center">
                                ...
                                <p className="catalog-muted mb-4 text-[1.02rem]">
                                    Entre em contato via WhatsApp: <span className="font-bold">{formatPhoneNumber(product.whatsapp_number)}</span>
                                </p>
                                <div className="catalog-detail-cta-note rounded-2xl p-4 mb-5">
                                    <p className="catalog-heading font-semibold mb-1">Atendimento para orcamento</p>
                                    <p className="catalog-muted text-sm">
                                        Envie sua ideia, medidas ou referencia e receba um atendimento rapido para montar sua proposta.
                                    </p>
                                </div>
                                <a
                                    href={whatsappLink}
